...
<div class="row">
	<aside class="col-md-3">
		<ul class="list-group">
			...
			<a class="list-group-item" href="<spring:url value='/customer/logout'/>">Log Out</a>
		...
		<article class="card mb-3" id="overview">
			<div class="card-body">
				...
				<figure class="icontext">
						...
						<div class="text">
							<p><strong> ${sessionScope.customer_details.firstName}  ${sessionScope.customer_details.lastName}</strong> <br> 
							${sessionScope.customer_details.email} <br> </p>
